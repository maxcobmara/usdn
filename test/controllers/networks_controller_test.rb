...
class NetworksControllerTest < ActionController::TestCase
  ...
  test "should create network" do
    assert_difference('Network.count') do
      post :create, network: { description: @network.description, ip_range: @network.ip_range, name: @network.name }
    end
  ...
  test "should update network" do
    patch :update, id: @network, network: { description: @network.description, ip_range: @network.ip_range, name: @network.name }
    assert_redirected_to network_path(assigns(:network))
  end
